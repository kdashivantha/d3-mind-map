...
exports.d3Drag = function (simulation, svg, nodes) {
  ...
  var dragged = function dragged(node) {
    node.fx = d3_1.event.x;
    node.fy = d3_1.event.y;
  };
...
exports.d3NodeClick = function (d, i) {
  d3_1.event.stopPropagation();
...
},{"d3":"node_modules/d3/index.js"}],"node_modules/uuid/lib/rng-browser.js":[function(require,module,exports) {
...
},{"./v1":"node_modules/uuid/v1.js","./v4":"node_modules/uuid/v4.js"}],"utils/dimensions.ts":[function(require,module,exports) {
"use strict";
...
exports.getDimensions = function (html, style, classname) {
  ...
  document.body.append(el); //@ts-ignore

  dimensions.width = el.offsetWidth; //@ts-ignore

  dimensions.height = el.offsetHeight; //el.remove()
...
exports.getViewBox = function (nodes) {
  var Xs = [];
  var Ys = [];
...
},{}],"mindmap.ts":[function(require,module,exports) {
"use strict";
...
var d3_2 = require("./utils/d3");

var uuid_1 = __importDefault(require("uuid"));

var dimensions_1 = require("./utils/dimensions");

var nodeToHTML_1 = __importDefault(require("./nodeTemplates/nodeToHTML"));
...
function () {
  ...
  MindMap.prototype.prepareNodes = function () {
  ...
  MindMap.prototype.clickNode = function (d) {
  ...
  MindMap.prototype.addNewNode = function (target) {
    var nodeId = uuid_1.default();
    this.nodes.push({
      id: nodeId,
      text: "new-node",
      fx: target.fx,
  ...
  MindMap.prototype.removeNode = function (d) {
  ...
  MindMap.prototype.editNode = function (d) {
...
},{"d3":"node_modules/d3/index.js","./utils/d3":"utils/d3.ts","uuid":"node_modules/uuid/index.js","./utils/dimensions":"utils/dimensions.ts","./nodeTemplates/nodeToHTML":"nodeTemplates/nodeToHTML.ts"}],"data/mapdata.ts":[function(require,module,exports) {
"use strict";
...
var mapdata_1 = __importDefault(require("./data/mapdata"));

function init() {
  var data = __assign({}, mapdata_1.default);

  var svgEl = document.getElementById("map");
  var mindmap = new mindmap_1.MindMap(svgEl, data);
  mindmap.renderMap();
}

init();
},{"./mindmap":"mindmap.ts","./data/mapdata":"data/mapdata.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/d3-mind-map.77de5100.js.map